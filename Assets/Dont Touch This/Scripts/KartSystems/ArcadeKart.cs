...
namespace KartGame.KartSystems
{
    ...
    //    public bool useController;
        ...
        void MoveVehicleController(float accelerate, float brake, float turnInput)
        {
            ...
            bool isBraking = (localVelDirectionIsFwd && brake > 0.1f) || (!localVelDirectionIsFwd && accelerate > 0.1f);
